...
Функционал: _0004 Права доступа Продавец
...
Сценарий: _0004_2 Права доступа на документ Заказ
	...
	* Проверка создания, заполнения и открытия документа Заказ
		Если В командном интерфейсе я выбираю 'Продажи' 'Заказы' Тогда
			...
			Иначе 
				Если мне не доступна роль "Администратор" Тогда
					И я вызываю исключение "Установлены полные права или Права продавца работают некорректно"
